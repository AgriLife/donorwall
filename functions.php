...
function my_theme_enqueue_styles() {
	...
	$showcase_style = 'rayden-showcase';
	$hero_style = 'rayden-hero';
	$portfolio_style = 'rayden-portfolio';
	$blog_style = 'rayden-blog';
	$shortcodes_style = 'rayden-shortcodes';
	$assets_style = 'rayden-assets';
	$shop_style = 'rayden-shop';
	$parent_style = 'parent-style';
	
	wp_enqueue_style( $showcase_style, get_template_directory_uri() . '/css/showcase.css' );
	wp_enqueue_style( $hero_style, get_template_directory_uri() . '/css/hero.css' );
...
if( !function_exists('rayden_child_kses_allowed_html') ){

	function rayden_child_kses_allowed_html($tags, $context) {
	...
	add_filter( 'wp_kses_allowed_html', 'rayden_child_kses_allowed_html', 9, 2 );
